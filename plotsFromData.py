...
for i in range(len(data_from_arduino)):
    for j in range(len(data_from_arduino[i])):
        t = 0.0
        for k in range(len(data_from_arduino[i][j])):
            t = t + data_from_arduino[i][j][k]
...
# Таблица 1
table_output_1 = data_from_arduino

# Таблица 2
table_output_1 = data_a_e_M
